...
function (_Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      console.log(data);
      console.log(payload); // 2. Filter the deleted item out of the page

      data.items = data.campaignItems.filter(function (item) {
...
//# sourceMappingURL=dashboard.js.83c6775a27b80f8178e2.hot-update.js.map