    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return data.campaignScripts.map(function (cScript, i) {
            ...
            _this2.state.targetCandidates.map(function (cand, i) {
              ...
              _lib_legislators__WEBPACK_IMPORTED_MODULE_3__["legislators"].map(function (q) {
                ...
                if (q.id.bioguide === scriptID // cand.answer === cScript.targetCondition2
                    ...
                    console.log(q); // console.log(q.id.bioguide);
                    // console.log(scriptID);
                    // console.log(cand.answer);
                    // console.log(cScript.targetCondition2);
          ...
          cScript.tally = tally;
          console.log(cScript); // if (cScript.tally == 10) {
...
//# sourceMappingURL=preview.js.ec7e06fa02918e7a098d.hot-update.js.map