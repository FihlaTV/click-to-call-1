    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return data.campaignScripts.map(function (cScript, i) {
          ...
          if (cScript.targetCondition2) {
            _this2.state.targetCandidates.map(function (cand, i) {
              ...
              _lib_legislators__WEBPACK_IMPORTED_MODULE_3__["legislators"].map(function (q) {
                if (q.id.bioguide === scriptID && cand.answer === cScript.targetCondition2) {
                  cScript.tally = cScript.tally + 3;
          ...
          console.log(cScript); // console.log(cScript.data)

          if (cScript.data[0]) {
            var arraycontainskeyword = cScript.data.indexOf(candidateName) > -1; // If target candidate matches address and ZIP, show this script
...
//# sourceMappingURL=preview.js.336e71a6e490a1d0eb69.hot-update.js.map