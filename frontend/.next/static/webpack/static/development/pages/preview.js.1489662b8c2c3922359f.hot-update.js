  ...
  _createClass(MatchedScripts, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        var legislatorArray = []; // console.log(legislators);

        _lib_people__WEBPACK_IMPORTED_MODULE_4__["houseMembers"].map(function (hm) {
          var dis = hm.district;
          var st = hm.state;
          houseMemberArray.push(st + "-" + dis);
        });
        _lib_legislators__WEBPACK_IMPORTED_MODULE_3__["legislators"].map(function (leg) {
          var arr = leg.terms;
          var recentterm = arr[arr.length - 1];
          legislatorArray.push(leg.name.official_full + ", " + recentterm.state + "-" + recentterm.district); // console.log(leg);
        });
        console.log(houseMemberArray);
        console.log(legislatorArray); // Loops through all possible scripts
...
//# sourceMappingURL=preview.js.1489662b8c2c3922359f.hot-update.js.map